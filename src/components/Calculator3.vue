<template>
  <div class="wrapper">
    <div class="display">
      <input class="display__input" type="number" name="operand1" :value="+operand1" @input="aa" />
      <input class="display__input" type="number" name="operand2" :value="+operand2"  @input="aa" />
